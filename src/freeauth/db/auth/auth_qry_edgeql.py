# AUTOGENERATED FROM:
#     'queries/create_audit_log.edgeql'
#     'queries/get_login_setting.edgeql'
#     'queries/get_login_setting_by_key.edgeql'
...
#     'queries/sign_up.edgeql'
#     'queries/upsert_login_setting.edgeql'
#     'queries/validate_code.edgeql'
#     'queries/validate_pwd.edgeql'
# WITH:
#     $ edgedb-py -I FreeAuth --target blocking --file auth_qry_edgeql.py
...
class GetUserByAccessTokenResult(NoPydanticValidation):
    ...
    email: str | None
    mobile: str | None
    org_type: GetUserByAccessTokenResultOrgType | None
    departments: list[GetUserByAccessTokenResultDepartmentsItem]
    roles: list[GetUserByAccessTokenResultRolesItem]
    is_deleted: bool
    created_at: datetime.datetime
...
@dataclasses.dataclass
class GetUserByAccessTokenResultDepartmentsItem(NoPydanticValidation):
    id: uuid.UUID
    code: str | None
    name: str
...
@dataclasses.dataclass
class GetUserByAccessTokenResultOrgType(NoPydanticValidation):
    id: uuid.UUID
    code: str | None
    name: str
...
@dataclasses.dataclass
class GetUserByAccessTokenResultRolesItem(NoPydanticValidation):
    id: uuid.UUID
    code: str | None
    name: str
