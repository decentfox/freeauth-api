...
# WITH:
#     $ edgedb-py -I FreeAuth --target async --dir src/freeauth/db/admin --file src/freeauth/db/admin/admin_qry_async_edgeql.py
...
async def create_permission_tag(
    executor: edgedb.AsyncIOExecutor,
    *,
    name: str,
...
async def delete_permission_tag(
    executor: edgedb.AsyncIOExecutor,
    *,
    ids: list[uuid.UUID],
...
async def reorder_permission_tags(
    executor: edgedb.AsyncIOExecutor,
    *,
    ids: list[uuid.UUID],
...
async def update_permission_tag(
    executor: edgedb.AsyncIOExecutor,
    *,
    id: uuid.UUID,
    name: str,
