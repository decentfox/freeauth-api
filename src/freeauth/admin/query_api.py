# AUTOGENERATED FROM:
#     'applications/queries/create_application.edgeql'
#     'audit_logs/queries/create_audit_log.edgeql'
#     'organizations/queries/create_department.edgeql'
#     'organizations/queries/create_enterprise.edgeql'
#     'organizations/queries/create_org_type.edgeql'
#     'permissions/queries/create_permission.edgeql'
#     'roles/queries/create_role.edgeql'
#     'users/queries/create_user.edgeql'
#     'applications/queries/delete_application.edgeql'
#     'organizations/queries/delete_org_type.edgeql'
#     'organizations/queries/delete_organization.edgeql'
#     'permissions/queries/delete_permission.edgeql'
#     'roles/queries/delete_role.edgeql'
#     'users/queries/delete_user.edgeql'
#     'organizations/queries/get_department_by_id_or_code.edgeql'
#     'organizations/queries/get_enterprise_by_id_or_code.edgeql'
#     'settings/queries/get_login_setting.edgeql'
#     'settings/queries/get_login_setting_by_key.edgeql'
#     'organizations/queries/get_org_type_by_id_or_code.edgeql'
#     'organizations/queries/get_organization_node.edgeql'
#     'permissions/queries/get_permission_by_id_or_code.edgeql'
#     'roles/queries/get_role_by_id_or_code.edgeql'
#     'auth/queries/get_user_by_access_token.edgeql'
#     'auth/queries/get_user_by_account.edgeql'
#     'users/queries/get_user_by_id.edgeql'
#     'organizations/queries/organization_bind_users.edgeql'
#     'organizations/queries/organization_unbind_users.edgeql'
#     'permissions/queries/perm_bind_roles.edgeql'
#     'permissions/queries/perm_unbind_roles.edgeql'
#     'organizations/queries/query_org_types.edgeql'
#     'permissions/queries/query_permission_tags.edgeql'
#     'users/queries/resign_user.edgeql'
#     'roles/queries/role_bind_users.edgeql'
#     'roles/queries/role_unbind_users.edgeql'
#     'auth/queries/send_code.edgeql'
#     'auth/queries/sign_in.edgeql'
#     'auth/queries/sign_out.edgeql'
#     'auth/queries/sign_up.edgeql'
#     'applications/queries/update_application_status.edgeql'
#     'organizations/queries/update_department.edgeql'
#     'organizations/queries/update_enterprise.edgeql'
#     'organizations/queries/update_org_type.edgeql'
#     'organizations/queries/update_org_type_status.edgeql'
#     'permissions/queries/update_permission.edgeql'
#     'permissions/queries/update_permission_status.edgeql'
#     'roles/queries/update_role.edgeql'
#     'roles/queries/update_role_status.edgeql'
#     'users/queries/update_user.edgeql'
#     'users/queries/update_user_organization.edgeql'
#     'users/queries/update_user_roles.edgeql'
#     'users/queries/update_user_status.edgeql'
#     'settings/queries/upsert_login_setting.edgeql'
#     'auth/queries/validate_code.edgeql'
#     'auth/queries/validate_pwd.edgeql'
# WITH:
#     $ edgedb-py --file query_api.py
