# AUTOGENERATED FROM:
#     'src/freeauth/applications/queries/create_application.edgeql'
...
#     'src/freeauth/applications/queries/delete_application.edgeql'
...
#     'src/freeauth/applications/queries/update_application_status.edgeql'
